...
yer all a yell'r	yer all a yell'r	false	445304660	--	"really"	"really"	--	post-gretta-help rule	"You point out just how bad [yer all] is. With logic, of course, but more importantly with an appeal to emotion. Why, the singer/author didn't have any remotely popular follow-ups! That sort of thing. But more importantly, you just keep nagging [the players] with 'Really?! REALLY?'[paragraph break]It's an effective strategy when logic isn't on your side, and here, it really (heh!) is. The [players] turn the music down, complaining that you are draining the energy all up in here. Gretta looks slightly relieved. As the 'music' fades, you remember the joker who actually wrote and sang it: Ellray Lyerla."
...
odes song	"The odes song sounds warpy for a second or two. Who knows, maybe you could get rid of it, even if it's not REALLY hurting you."
