...
scripture picturers	"[if cleric circle is visited]You've gotten inside. The chantries and picturers are no longer useful clues.[else][one of]Going in to the church is not so easy. Simply saying [b]IN[r] isn't churchy enough.[plus][or]You need to be a little more flowery to enter the church. Is there any clue?[plus][or][b]DIE SIN[r] becomes something new.[plus][or]You can kick the sign to change it to [b]SIN DIE[r] for another clue.[plus][or][b]INSIDE[r].[minus][cycling][end if]"	--	"INSIDE"
...
THE BEAN	"[one of]The Bean has given you a place to go or look--or, rather, a not-quite-direction.[plus][or]The ground feels a little shakier since [the bean] landed, but not enough to go straight down.[plus][or]PUSHing the Bean seems useless.[plus][or]You can go [b]BENEATH THE BEAN[r].[minus][cycling]"	--	"BENEATH"
...
red vees	"[one of]You have to believe it's worth it for you to do something with the red vees. That you're good enough.[plus][or]You must learn to [b]DESERVE[r] to use them.[minus][cycling]"	--	"DESERVE"
