...
be ova	"[one of][be ova] doesn't signal the end. Maybe the end of the beginning, or the beginning of the end.[or]The letters do seem a bit forced, but there are five. You need to look somewhere instead of at [be ova].[or]You need to look ABOVE.[cycling]"	--	"ABOVE"
...
Eh At Heat	"[one of]Man! You're just upset about what happened to you. Maybe there's a way your emotions could make you warmer.[plus][or]There's an emotion you can physically boil over with that anagrams with [heat].[or]You can HATE for a quick surge.[minus][cycling]"	--	"HATE"	[start TROVES hinting]
Race Acre	"[one of]You can't be bothered with the Race Acre since you're drained from that hate. You need a new approach to get going again.[or]You need to CARE.[minus][cycling]."	--	"CARE"
...
RESIDE RESIDE	"[one of]Si Reed wants to help you focus on certain mental stuff.[plus][or]Do not get too hippy-trippy on yourself. Without material DESIRE, nobody would want or build anything.[minus][cycling]"	--	"DESIRE"
Si Reed	--	RESIDE RESIDE
...
bogus-lamps	"[one of]The plasm lamps can inspire you to do something else. Something a templar might do.[plus][or]The action for a bonus point is more commonly known as a noun, but it works as a verb, too.[plus][or]PSALM.[minus][cycling]"
