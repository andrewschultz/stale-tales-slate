...
hump	hump	false	287929218	Austerer Treasure	"umph"	"umph"	--	post-hump-umph rule	"You don't need to ham up 'Hup, ma!' to get over a hump, because it's enough just to try umph. The hump vanishes once you get oveer it[if Leo is touchable]. [l-n-r] follow, jumping unnecessarily[end if]."
...
sweatier wait seer	sweatier wait seer	false	695435442	--	"weariest"	"weariest"	--	--	"The wait-seer blinks as if enlightened, folowed by a head-shake and a nod in your direction. The wait-seer trudges off to find somewhere more scenic to meditate, or perhaps someone else to block and, eventually, enlighten."
...
ur pine	nastier stainer retinas	false	513602032	--	"punier"	"punier"	--	post-urpine-punier rule	"The ur-pine shrinks and flails. Behind it is ... worse. Stainer retinas. Wait ... not just any stainer retinas. NASTIER stainer retinas. They must be guarding something!"
nastier stainer retinas	succor crocus	true	528602068	--	"antsier"	"antsier"	--	--	"The stainer retinas blink and begin to lose focus. You stare them down. They blink some more. Then they look from side to side. A long pause, perhaps pondering they'd been tougher to make antsier if 'nastier' weren't so similar, then ... they trail off to who knows where.[paragraph break]Behind them is a rare succor crocus--which can bring more happiness than a We-ROFL flower! But it is dying, dingy. When you bring the top opt pot near, though, the blub bulb opens up. It and the succor crocus are a perfect fit! You put the crocus in the top opt pot, and it blooms slightly."
...
to say scep-scan-track:
	if got-thru-respect is true:
		...
		say "You kind of avoided the cheat-scanning I came here for, but I respect your intrepid stance agsinst cheating, even if it really isn't cheating.";
	else:
