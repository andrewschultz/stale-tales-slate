...
rivets	rivets	false	564671562	--	"strive"	"strive"	"You make up your mind to strive. You strive to strive even more. You strive to make others strive. You feel twice as useful as you did a minute ago. You feel all, BAM! MBA[if praise spirea is reflexed]. Boy, you feel extra well rounded now. You want money and power for lots of different reasons![else].[end if]"
...
starch charts	starch charts	false	343183489	--	"trasch"	"trasch"	"You realize the charts themselves are a bunch of nonsense. Calling them trash sort of works as a noun or an interjection, but you maul them anyway. It [if shack-flip-yet is true]clues[else]reinforces[end if] to you that you'll be using mostly nouns--and maybe a verb, since you can trash things--inside the hacks['] shack."
...
frat raft	frat raft	false	217136535	--	"fart"	"fart" or "fart on raft"	"Channeling frat, uh, co-eds['] humor, you fail to keep your tush shut, thus. Your gust-guts cause the oars, of all things, to grow larger, as if they have gained the gas for propulsion.[paragraph break]It's kind of disgusting, but at least it's not wasteful!"
...
parrot	"The parrot seems to roll its eyes at you, as if to say, [unless player is in Coevals' Alcoves]not here[else]you DO remember what I was[end if]."
...
bench-end	"[if old giant is moot][giant-over][else if nuder is in Same MesaMaybe deal with Rude [']N Nuder, now[else]You got on the bench right. Time to start ducking[end if]."
...
Elmer	--	Merle
Merle	"[if parrot is in Coevals' Alcoves]You can't change Elmer or Merle directly, but you may want to mess with the parrot[else]You can't really deal with Elmer and Merle until you have an ally[end if]. [if merle is reflexed][one of]You can, however, make Elmer and Merle change for a Last Lousy Point.[plus][or]What is the opposite of on-the-sly?[plus][or]Elmer and Merle can be made to speak HONESTLY.[minus][cycling][else]You can just enjoy their random squabbles as you figure what the parrot needs to do or become.[end if]"	--	"Elmer and Merle can speak HONESTLY"
...
Edictal Citadel	"The Edictal Citadel is where Elvira's hiding out. You need to get [if Reclusion Inclosure is visited]in[else]back[end if] there and be prepared."
