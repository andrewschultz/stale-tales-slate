...
this is the post-gretta-help rule:
	...
	if uber-rand-cheat is true:
		if number of pickup-lines in Disowned Downside is 0:
			say "You're done! Somehow. This shou;dnt happen, but you are.";
...
n-t-air	"[one of]Nowt Town may make you feel lethargic. You can find a quick word that substitutes as an interjection but isn't really one.[plus][or]You won't get full points for the (non-profane) four-letter word.[plus][or]say WONT to dispel the maze.[minus][cycling]"
