...
to say trout-tut:
	...
	say "She explains someone deserves a reward. He's all 'A donut, Aunt! Do!' but she says diabetes is not the best idea. Not even a tater treat. But she hands you Paw R Wrap wrap--a present from someone named Valeri, who used to be so nice but never shows up any more[if tray is touchable]--and also jerks her head towards the tray[end if].[paragraph break]You doubt Aunt Tuna has anything else for you[if wipes are reflexive], though maybe you could sneak the wipes[end if][if dent is touchable]. Maybe you could fix the dent[end if]. But you should probably explore elsewhere";
...
tea tray	"[one of]Tea looks tasty. And easy to dispose of.[plus][or]You can EAT the tea.[minus][cycling]"	--	"[if trout is reflexive]TUTOR Tortu the trout, then [end if]EAT the tea tray"
