...
clam	"[one of]The clam is agitated. It probably doesn't want to attack you.[plus][or]You need to settle the clam down.[plus][or]I mean CALM it.[minus][cycling]"	--	"CALM the clam"
urn	"[one of]You can't walk away from the urn. You need to do something more decisive.[plus][or]You should RUN from the urn.[minus][cycling]"	--	"RUN from the urn"
...
sabot boats	"[one of]The sailors aboard the sabot boats seem to like a good chat about accomplishments.[plus][or]How could you get the sabot boats['] attention with your own bragging or self-promotion?[plus][or]BOAST.[minus][cycling]"	--	"BOAST at the sabot boats"
crays	--	plea
plea	"[one of]You can't change the crays, but the plea offers a way out. The pale plea.[plus][or]You are feeling too jumpy to just plain jump, so you need to...[plus][or]...LEAP.[minus][cycling]"	--	"LEAP by the plea"
...
fish	--	canoe
oars	"[one of]Those oars provide propulsion.[plus][or]And not just through the water.[plus][or]SOAR.[minus][cycling]"	--	"SOAR by the oars"
carps	"[one of]You're bigger than they are, and your arms have more reach. You could probably beat them in a fight.[plus][or]You could brawl, tussle, or...[plus][or]SCRAP.[minus][cycling]"	--	"SCRAP (with) the carps"
...
sausage	"[if sausage is reflexed][one of]Now you've gained its trust, you will want to show [the sausage] something.[plus][or]The [sausage] would love to know where the ruby is buried.[minus][cycling][else][one of]The [sausage] seems upset. How would you calm it down?[plus][or]You can ASSUAGE the sausage.[minus][cycling][end if]"	--	"ASSUAGE the Use-Saga Sausage"
