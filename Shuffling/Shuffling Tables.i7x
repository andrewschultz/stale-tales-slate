...
chisel	"[one of]That chisel might be handy for some items [if player is in Emptiness Sepiments]you'll need to pass the drapes[else]stuck to a wall, or something[end if].[plus][or]What could it PEEL?[plus][or]Either of the livers[i-fle].[minus][cycling]"
liches	"[one of]The liches are a tool of some greater evil, and their descriptions suggest another word.[plus][or]Make them into a CHISEL.[minus][cycling]"
...
to say put-can: say "[one of]Examining the livers indicates they need to be processed.[plus][or]You need to put both livers in the canister.[plus][or][unless River Ville liver is moot]PUT River Ville IN CANISTER. [end if][unless viler liver is moot]PUT VILER LIVER IN CANISTER. [end if][minus][cycling][no line break]"
