Version 5 of Glulx Text Effects - New (for Glulx only) by Emily Short begins here.

"Glulx Text Effects provides an easy way to set up special text effects for Glulx."


Section - Glulx color value KOV
...
special-style is a kind of value. The special-styles are normal-style, italic-style, fixed-letter-spacing-style, header-style, bold-style, alert-style, note-style, blockquote-style, input-style, special-style-1 and special-style-2.
...
Section - Phrases for invoking styles
...
Glulx Text Effects - New ends here.
