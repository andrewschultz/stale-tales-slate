...
[ open g-required ung-present windows. start with directly spawned windows.
  close g-unrequired g-present windows. start with childless! ]
	...
	let xy be the number of next-step g-required g-unpresent g-windows;
	while g is a g-window:
		g-make g;
		let g be a random next-step g-required g-unpresent g-window;
		if xy is the number of next-step g-required g-unpresent g-windows:
			break;
		now xy is the number of next-step g-required g-unpresent g-windows;
