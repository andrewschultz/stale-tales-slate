"roust-tours-torus" by Andrew

volume hexroom definitions

rule for printing the name of a hex-ok hexroom: say "[word-to-include of the item described in title case]"

a hexroom is a kind of room. a hexroom has text called word-to-include. a hexroom has text called guess-right-text. a hexroom can be hex-ok. a hexroom is usually not hex-ok. a hexroom can be solved. a hexroom is usually not solved.
...
Prep Area is a hexroom. it is northeast of Ehs Ehs. "This is the northwest room in what seems to be a hexagonal ring. [hexround].". word-to-include is "reappear". guess-right-text is "You back out a bit, then reappear.". clue-text is "You feel like you are being watched. You want to duck out and in, but not in the standard directions"

Grain Grain is a hexroom. it is east of Prep Area. "This is the northeast room in what seems to be a hexagonal ring. [hexround].". printed name is "Grain, Grain". word-to-include is "arraigning". guess-right-text is "The grain turns into a court of law, but since you have no guilt, you are free to go.". clue-text is "You feel on trial. Well, not quite, but you feel a need for acquital for ... something"

Meta Meat is a hexroom. it is southeast of Ehs Ehs. "This is the southwest room in what seems to be a hexagonal ring. [hexround].". word-to-include is "teammate". guess-right-text is "Someone comes along and bangs at the barrier [hexdir]. You hear a small cracking.". clue-text is "You feel as if a friend or confidante could help you make a dent in the Attentat Tent, here"

Tines Inset is a hexroom. it is east of Meta Meat. "This is the southeast room in what seems to be a hexagonal ring. [hexround].". word-to-include is "intestines". guess-right-text is "You find the guts to turn the place into something more gross, but manageable.". clue-text is "You feel disjointed from the whole body of rooms here"
