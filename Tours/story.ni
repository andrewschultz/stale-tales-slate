...
Tines Inset is a dubroom. it is a1 of Meta Meat. it is a2 of Grain Grain. it is a3 of Prep Area. it is b3 of Ehs Ehs. "This is the southeast [torus-area]. [heptround].". word-to-include is "intestines". guess-right-text is "You find the guts to turn the place into something more gross, but manageable.". done-text is "You are just glad you don't have to deal with digestive juices or anything here.". clue-text is "You feel disjointed from the whole body of rooms here". sts-hash of Tines Inset is 441090447.
